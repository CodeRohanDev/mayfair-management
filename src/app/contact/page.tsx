                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                                ...
                                <div className="space-y-0">
                                    ...
                                    <div className="pt-8">
                                        ...
                                        <p className="text-2xl font-medium text-gray-700 mb-1">Matt Nacier, <a href="mailto:info@may-fairmanagement.com" className="underline hover:opacity-80 transition-opacity" style={{ color: '#4080bf' }}>info@may-fairmanagement.com</a></p>
                                    </div>

                                    {/* Investor Relations */}
                                    <div className="pt-4">
                                        <h3 className="text-2xl font-semibold text-gray-800 mb-3">FOR INVESTOR and MEDIA RELATIONS</h3>
                                        <p className="text-2xl font-medium text-gray-700 mb-1">Betsy Corbin, <a href="mailto:info@may-fairmanagement.com" className="text-teal-600 hover:text-teal-800 underline">info@may-fairmanagement.com</a></p>
                                    </div>

                                    {/* General Inquiries */}
                                    <div className="pt-4">
                                        <h3 className="text-2xl font-semibold text-gray-800 mb-3">FOR GENERAL INQUIRIES</h3>
                                        <p className="text-2xl text-gray-700 mb-1"><a href="mailto:info@may-fairmanagement.com" className="text-teal-600 hover:text-teal-800 underline">info@may-fairmanagement.com</a></p>
                                    </div>
