...
export default function Footer() {
  return (
    <footer className="text-white py-18" style={{ backgroundColor: '#06152a' }}>
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="space-y-0 text-lg font-medium text-white">
              <p>{companyData.contact.company}</p>
              <p>{companyData.contact.city}</p>
              <p>{companyData.contact.country}</p>
              <br />
            ...
            {/* <div className="flex space-x-4">
              ...
              <a
                ...
                aria-label="Connect with us on LinkedIn"
              >
                <svg className="h-10 w10" fill="currentColor" viewBox="0 0 24 24">
