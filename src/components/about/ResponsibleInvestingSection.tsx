      ...
      <Container>
        <div className="max-w-6xl mx-auto px-4 md:px-0">
          <div className={`flex items-center justify-center mb-8 md:mb-16 `}>
            ...
            <h2 className="text-2xl md:text-5xl font-light text-center mx-4 md:mx-8 tracking-wider" style={{ color: '#0a1b2f' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-6">
            <div className="space-y-4 md:space-y-0 lg:order-1 lg:col-span-2">
              ...
              <p className="text-gray-700 text-sm md:text-2xl leading-relaxed">
                The United Nations Principles for Responsible Investing (UNPRI) is the springboard for MayFair Management&apos;s ESG approach, and its early entry into adopting an ESG strategy means there is added experience and perspective to each one of MayFair Management&apos;s investments. The firm&apos;s executives also work alongside portfolio management teams to develop strategic and sustainable plans for their businesses. This means that each company&apos;s ESG strategies are unique and tailored to their business, operations and industry.
              </p>
            </div>
